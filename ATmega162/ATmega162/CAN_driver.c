...
// 	char data;
// 	intr = mcp2515_read(MCP_CANINTF);
// 	printf("Send flag before send: %i\n", intr);
// 	data = mcp2515_read(MCP_TXB0_D0);
// 	printf("Data in message: %i\n", msg->data[0]);
// 	printf("Data in register: %i\n", data);
